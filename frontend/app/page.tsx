    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
      <div className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-12 text-left">
          <a href="./roof-detection" className="p-6 bg-gray-800 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
          ...
          <a href="./solar-estimation" className="p-6 bg-gray-800 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
          ...
          <a href="./dashboard" className="p-6 bg-gray-800 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
            <div className="text-4xl mb-2">💰</div>
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <a href="./dashboard" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg">
            Open App
          </a>
